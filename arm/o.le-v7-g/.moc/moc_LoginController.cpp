/****************************************************************************
** Meta object code from reading C++ file 'LoginController.hpp'
**
...
#include "../../../src/controllers/LoginController.hpp"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'LoginController.hpp' doesn't include <QObject>."
...
static const char qt_meta_stringdata_LoginController[] = {
    "LoginController\0\0authorized()\0webview\0"
    "authorize(WebView*)\0"
};
...
void LoginController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->authorize((*reinterpret_cast< WebView*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
